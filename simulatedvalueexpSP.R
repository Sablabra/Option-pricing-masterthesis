...
x = 3:12
k = 1:order
plot(x,Price_errorreg,type = "l", col = "red",ylim=c(0,0.04),ylab = "error",xlab="order of polynomial")
...
x = 3:12
k = 1:order
plot(x,Delta_errorreg,type = "l", col = "red",ylim=c(0,0.4),ylab = "error",xlab="order of polynomial")
